(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@remix-run/web-file')) :
  typeof define === 'function' && define.amd ? define(['exports', '@remix-run/web-file'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.parseNestedFormData = {}, global.RemixRunWebFile));
})(this, (function (exports, webFile) { 'use strict';
  ...
  function isJsonObject(val) {
    return typeof val === 'object' && !Array.isArray(val) && val !== null && !(val instanceof webFile.File);
  }
